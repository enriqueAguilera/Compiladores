...
class Thompson:
	...
	def convertir(self,cadena):
		...
		for item in abecedario:
			lenguaje.append(item)	#obtenemos el abecedario en minusculas por que es lo que vamos a checar primero en la cadena
		...
		obtenerCerraduraEstrella(cadena)
	...
	def obtenerCerraduraEstrella(self,cadena):
		...
		automata.append(plantillaEstrella(lista_completa))
		print(automata)
	...
	def obtenerCerraduraPositiva(self,cadena):
		...
		lista_completa+=expresion_normal
		lista_completa+=expresion_parentesis
		automata.append(plantillaPositiva(lista_completa))
	

	def obtenerCerraduraOr(self,cadena):
		automata=[]
		lista_completa=[]
		expresion_normal=[]
		expresion_parentesis=[]
		...
		lista_completa+=expresion_normal
		lista_completa+=expresion_parentesis
		plantillaPositiva(lista_completa)
